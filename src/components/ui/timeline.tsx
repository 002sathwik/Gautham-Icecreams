...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-gradient-to-r from-pink-700 via-amber-500 to-lime-600  dark:bg-neutral-950 font-sans md:px-10"
      ref={containerRef}
    >
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className=" font-grotesk hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-white ">
                {item.title}
              </h3>
            </div>

            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden font-grotesk block text-2xl mb-4 text-left font-bold text-white">
                {item.title}
              </h3>
