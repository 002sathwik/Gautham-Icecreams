...
export default function HeroSection() {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="z-30 absolute bottom-5 md:bottom-40 w-full text-center">
        <h1 className="text-white text-3xl md:text-6xl font-bold font-grotesk bg-opacity-60 inline-block px-4 py-2 rounded-lg">
          "Experience Magic of Gautham Icecream "
        </h1>
        <p className="mt-2 caption max-w-2xl mx-auto font-sora">
